export const beverages: Beverage[] = [
    { name: "Cola", ingredients: ["sugar", "caffeine", "water"], fillingQuantity: "1ltr", price: 1, description: "a nice brown drink", color: "brown" },
    ...
    { name: "MilkCoffee", ingredients: ["milk", "coffee", "sugar", "caffeine"], fillingQuantity: "0.2 ltr", price: 1.99, description: "a nice brown drink for breakfast", color: "brown" },
